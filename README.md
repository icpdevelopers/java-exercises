...
1. [**Student Grade Calculator**]() - Add students, calculate class average, assign grades. [coming soon]
2. [**Banking Account Manager**]() - Manage bank accounts with deposit, withdrawal, and balance. [coming soon]
3. [**Library Book Manager**]() - Track, borrow, and return books with search. [coming soon]
4. [**Expense Tracker**]() - Monitor daily expenses, categories, and monthly budget. [coming soon]
5. [**Contact Directory**]() - Add, update, and search for contacts. [coming soon]
6. [**Quiz Game Engine**]() - Play timed, scored quizzes with difficulty levels. [coming soon]
7. [**Password Manager**]() - Generate, store, and check password strength. [coming soon]
8. [**Inventory Manager**]() - Manage stock levels, restock alerts, and valuation. [coming soon]
9. [**Task Tracker**]() - Prioritize and schedule tasks with completion tracking. [coming soon]
10. [**ATM Simulator**](/ATM/README.md) - PIN-based ATM simulation with receipt generation.
11. [**Hangman Game**]() - Classic word guessing game with difficulty settings. [coming soon]
